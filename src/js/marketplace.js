...
App.purchaseListing = function () {
	...
	App.setStatus("Ordering now, please wait.", "warning");
	App.contracts.Marketplace.deployed().then(function (instance) {
		...
		console.log(result);
		App.setStatus("Item ordered in transaction: " + result.tx);
	})
};
...
App.createListing = function () {
	...
	App.setStatus("Offering Item, please wait.", "warning");
	App.contracts.Marketplace.deployed().then(function (instance) {
		return instance.addListing(listingName, listingPrice, {from: App.account});
	}).then(function (result) {
		console.log(result);
		App.setStatus("Item offered in transaction: " + result.tx);
	})
};